...
def scrape_amazon(search_query):
    # Convertir el espacio en búsqueda en '+', que es el formato de URL de Amazon
    search_query = search_query.replace(' ', '+')
    # URL de la página de búsqueda de Amazon
    url = f'https://www.amazon.com.mx/s?k={search_query}'
    ...
    if response.status_code == 200:
        ...
        # Amazon tiene varias clases para productos, esto puede requerir ajustes
        items = soup.find_all('div', {'data-component-type': 's-search-result'})
        
        desktop_path = get_desktop_path()
        csv_file_path = os.path.join(desktop_path, 'datos_amazon.csv')
        with open(csv_file_path, 'w', newline='', encoding='utf-8') as csvfile:
            ...
            for item in items:
                try:
                    ...
                    full_link = f'https://www.amazon.com.mx{link}'
...
# Consulta de búsqueda en Amazon
search_query = 'carpintero'
